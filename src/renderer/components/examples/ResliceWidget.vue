<template>
  <div>
    ...
    <div v-else>
      ...
      <div class="row">
        <div class="col">
          <view-2d :volumes="volumes" :on-created="saveView(0)" :parallel="true" />
        </div>
        <div class="col">
          <view-2d :volumes="volumes" :on-created="saveView(1)" :parallel="true" />
        </div>
        <div class="col">
          <view-2d :volumes="volumes" :on-created="saveView(2)" :parallel="true" />
        </div>
      </div>
    </div>
  </div>
