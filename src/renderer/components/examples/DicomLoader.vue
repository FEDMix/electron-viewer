<template>
  <div>
    ...
    <hr>
    <div>
      <input ref="files" type="file" multiple @change="handleFileUpload">
    </div>
    <hr>
    <!--    <div v-if="loading">-->
    <!--      <h3>Loading...</h3>-->
    ...
    <!--          <view-2d-->
    <!--            :volumes="volumes"-->
    <!--            :on-created="this.saveComponentReference(0)"-->
    ...
    <!--          <view-2d-->
    <!--            :volumes="volumes"-->
    <!--            :on-created="this.saveComponentReference(1)"-->
    <!--            :painting="focusedWidgetId === 'PaintWidget'"-->
    <!--            :paint-filter-background-image-data="paintFilterBackgroundImageData"-->
    <!--          />-->
    <!--        </div>-->
    ...
    <!--          <view-2d-->
    <!--            :volumes="volumes"-->
    <!--            :on-created="this.saveComponentReference(2)"-->
    <!--            :painting="focusedWidgetId === 'PaintWidget'"-->
    <!--            :paint-filter-background-image-data="paintFilterBackgroundImageData"-->
    <!--          />-->
    <!--        </div>-->
    ...
    <!--            :on-created="this.saveComponentReference(3)"-->
    <!--            :painting="focusedWidgetId === 'PaintWidget'"-->
    <!--            :paint-filter-background-image-data="paintFilterBackgroundImageData"-->
    <!--            :paint-filter-label-map-image-data="paintFilterLabelMapImageData"-->
    <!--          />-->
    <!--        </div>-->
    <!--      </div>-->
    <!--    </div>-->
