<template>
  <div>
    ...
    <div v-else>
      ...
      <div class="row">
        <div class="col">
          <view-2d :volumes="volumes" :on-created="onViewCreated(0)" />
        </div>
        <div class="col">
          <view-2d :volumes="volumes" :on-created="onViewCreated(1)" />
        </div>
        <div class="col">
          <view-2d :volumes="volumes" :on-created="onViewCreated(2)" />
        </div>
      </div>
    </div>
  </div>
